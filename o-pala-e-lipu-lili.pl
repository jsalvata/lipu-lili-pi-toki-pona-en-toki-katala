...
<body>
<input type="radio" name="lipu" id="sinpin" value="sinpin" checked> <label for="sinpin"><span class="linja-pona">sinpin: toki+pona</span></label>
<br/>
<input type="radio" name="lipu" id="monsi" value="monsi"> <label for="monsi"><span class="linja-pona">monsi: toki [_kalama_·_tan_·_lawa_· ]</span></label>
<br/>
<input type="checkbox" onClick="oNasa(this)" id="nasa"> <label for="nasa"><span class="linja-pona">o nasa e lipu lili</span></label>
<div class="lipu">
__E__
